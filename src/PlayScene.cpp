...
void PlayScene::m_movePlaneToTargetNode()
{
	if (m_bPatrolMode)
	{
		...
		if (targetVector.x == 1) //rotate according to plane's direction
		{
...
void PlayScene::start()
{
	...
	//td::cout << "normalized direction: (" << normalized.x << ", " << normalized.y << ")" << std::endl;
